...
**Pinned release: v0.3.3** (digest in `quadlet/artifactflow-release.image`).
...
4. **Restricted artifact-host database role**, the migration just created
   ...
   curl -fsSL https://raw.githubusercontent.com/Gadsotek/artifactflow/v0.3.3/docs/operations/artifact-host-database-grants.sql \
