...
**Pinned release: v0.3.2** (digest in `quadlet/artifactflow-release.image`).
...
4. **Restricted artifact-host database role**, the migration just created
   ...
   curl -fsSL https://raw.githubusercontent.com/Gadsotek/artifactflow/v0.3.2/docs/operations/artifact-host-database-grants.sql \
...
No new environment settings or artifact-host database grants are required for
this upgrade. Processor enablement stays unchanged. See the
[v0.3.0 release notes](https://github.com/Gadsotek/artifactflow/releases/tag/v0.3.0).
